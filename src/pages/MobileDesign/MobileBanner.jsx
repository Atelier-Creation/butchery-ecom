      ...
      >
        {images.map((src, idx) => (
          <SwiperSlide key={idx}>
            ...
            <div className="absolute w-full top-50 left-0 text-center lg:top-25 lg:left-5 flex flex-col lg:gap-3 gap-2 items-center lg:items-start justify-center lg:text-start text-white px-4 lg:w-1/2">
              <H2
                en={src.head.en}
                ta={src.head.ta}
